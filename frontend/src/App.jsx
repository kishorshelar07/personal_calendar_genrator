...
import Template4 from './pages/cal_design/Template4';
import Template5 from './pages/cal_design/Template5';
import Template6 from './pages/cal_design/Template6';
import Template7 from './pages/cal_design/Template7';
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<Layout />}>
          ...
          <Route path="/cal-design/template4/:id" element={<Template4 />} />
          <Route path="/cal-design/template5/:id" element={<Template5 />} />
          <Route path="/cal-design/template6/:id" element={<Template6 />} />
          <Route path="/cal-design/template7/:id" element={<Template7 />} />
        </Route>
      </Route>
